...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String province = request.getHeader("X-Request-Province");
        String username = request.getHeader("X-Request-Username");
        String password = request.getHeader("X-Request-Password");
        HttpSession session = request.getSession();
        UserService userService = new UserServiceImpl();
        String msg = userService.doLogin(username, password, province, session);
